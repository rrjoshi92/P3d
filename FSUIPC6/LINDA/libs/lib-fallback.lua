...
function EFIS_WPT ()
    ipc.writeLvar("L:MapItem Shown", 0)
    DspShow("EFIS", "WPT")
end

function EFIS_VORD ()
    ipc.writeLvar("L:MapItem Shown", 1)
    DspShow("EFIS", "VORD")
end

function EFIS_NDB ()
    ipc.writeLvar("L:MapItem Shown", 2)
    DspShow("EFIS", "NDB")
end

function EFIS_ARPT ()
    ipc.writeLvar("L:MapItem Shown", 3)
    DspShow("EFIS", "ARPT")
end
...
function EFIS_ADF1 ()
    ...
    ipc.writeLvar("L:VOR 1 Switch", 2)
    DspShow("ADF" , "1")
end
...
function EFIS_VOR1 ()
    ...
    ipc.writeLvar("L:VOR 1 Switch", 0)
    DspShow("VOR" , "1")
end
...
function EFIS_ADFVOR1_off ()
    ...
    ipc.writeLvar("L:VOR 1 Switch", 1)
    DspShow("VOR1" , "off")
end
...
function EFIS_ADF2 ()
	...
	ipc.writeLvar(LVarSet, 2)
    ipc.writeLvar("L:VOR 2 Switch", 2)
    DspShow("ADF" , "2")
end
...
function EFIS_VOR2 ()
	LVarSet = "EFIS VORADF2"
	ipc.writeLvar(LVarSet, 0)
    ipc.writeLvar("L:VOR 2 Switch", 0)
    DspShow("VOR" , "2")
end
...
function EFIS_ADFVOR2_off ()
	LVarSet = "EFIS VORADF2"
	ipc.writeLvar(LVarSet, 1)
    ipc.writeLvar("L:VOR 2 Switch", 1)
    DspShow("VOR2" , "off")
end

function EFIS_MAPMODE_ils ()
    ipc.writeLvar("L:Display Mode", 0)
    DspShow("MAP" , "ILS")
end

function EFIS_MAPMODE_vor ()
    ipc.writeLvar("L:Display Mode", 1)
    DspShow("MAP" , "VOR")
end

function EFIS_MAPMODE_nav ()
    ipc.writeLvar("L:Display Mode", 2)
    DspShow("MAP" , "NAV")
end

function EFIS_MAPMODE_arc ()
    ipc.writeLvar("L:Display Mode", 3)
    DspShow("MAP" , "ARC")
end

function EFIS_MAPMODE_inc ()
    MMvar = ipc.readLvar("L:Display Mode")
    if MMvar < 4 then
        MMvar = MMvar + 1
    end
    if MMvar == 0 then
...
function EFIS_BOEING_MAPMODE_app ()
    ipc.writeLvar("L:EFIS Mode", 0)
    DspShow("EFIS" , "APP")
end

function EFIS_BOEING_MAPMODE_vor ()
    ipc.writeLvar("L:EFIS Mode", 1)
    DspShow("EFIS" , "VOR")
end

function EFIS_BOEING_MAPMODE_map ()
    ipc.writeLvar("L:EFIS Mode", 2)
    DspShow("EFIS" , "MAP")
end

function EFIS_BOEING_MAPMODE_inc ()
    MMvar = ipc.readLvar("L:EFIS Mode")
    if MMvar < 3 then
        MMvar = MMvar + 1
    end
    if MMvar == 0 then
...
function EFIS_BOEING_MODE_centered ()
    ipc.writeLvar("L:MFD Centered", 1)
    DspShow("EFIS" , "Cent")
end

function EFIS_BOEING_MODE_uncentered ()
    ipc.writeLvar("L:MFD Centered", 0)
    DspShow("EFIS" , "UnCt")
end
...
function EFIS_MAPZOOM_10 ()
    ipc.writeLvar("L:Display Scale", 0)
    DspShow("ZOOM" , "10")
end

function EFIS_MAPZOOM_20 ()
    ipc.writeLvar("L:Display Scale", 1)
    DspShow("ZOOM" , "20")
end

function EFIS_MAPZOOM_40 ()
    ipc.writeLvar("L:Display Scale", 2)
    DspShow("ZOOM" , "40")
end

function EFIS_MAPZOOM_80 ()
    ipc.writeLvar("L:Display Scale", 3)
    DspShow("ZOOM" , "80")
end

function EFIS_MAPZOOM_160 ()
    ipc.writeLvar("L:Display Scale", 4)
    DspShow("ZOOM" , "160")
end

function EFIS_MAPZOOM_320 ()
    ipc.writeLvar("L:Display Scale", 5)
    DspShow("ZOOM" , "320")
end

function EFIS_MAPZOOM_inc ()
    MZvar = ipc.readLvar("L:Display Scale")
    if MZvar < 6 then
        MZvar = MZvar + 1
    end
    if MZvar == 0 then
