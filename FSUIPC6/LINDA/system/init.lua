...
ShowMessage('LINDA Restarting. PLEASE WAIT! Do not operate buttons', 60)
...
if ipc.get("HID_ENABLED") == 1 then
	...
	local config_hid = ipc.get("PATH_ACFT_CFG") .. 'FSX Default'
        .. "/config-hid"
	if file_exists(config_hid .. ".lua") then
        ...
        _log("[INIT] Open GUI, select FSX Default and click on Joystick ")
...
--ipc.setowndisplay('LINDA',50 , 30, 7, 3)
--ipc.display("LINDA READY...", 5) -- clear display
